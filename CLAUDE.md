...
> Sibling of the §14 client-trusted-money rule (which lands via the `claude/money-cluster-client-trusted-fix`
> branch — if that isn't merged yet, this section may need renumbering on reconcile).
