...
42. *(number reserved — Locked Decision 42 is not present in this file as of this append; the
    highest-numbered entry above is 41. This lane was instructed to number its entry 43 regardless
    so the two cannot collide when 42 lands. Do not renumber either.)*
