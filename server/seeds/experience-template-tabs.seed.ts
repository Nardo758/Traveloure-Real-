...
export async function seedExperienceTemplateTabs() {
  ...
  const templates: Array<{
    ...
    { slug: "wedding", name: "Wedding", tabs: weddingTabs, universalFilters: standardUniversalFilters, backfillControls: true,
      ...
      // `venue` first: for a wedding the place is the FIRST hire, and until migration 285 there was
      // no key for it (ledger `2026-09-04-venue-category`). `dining_venue` is a restaurant and
      // `accommodation` is a bed — neither is a hired hall, barn, estate or garden.
      rolesNeeded: ["venue", "event_coordinator", "florist", "photography", "videographer", "caterer", "officiant", "hair_makeup", "entertainment", "printing_materials", "rentals", "private_transportation"] },
    ...
    { slug: "reunions", name: "Reunions", tabs: reunionsTabs, universalFilters: standardUniversalFilters,
      switches: { stops: "many", duration: "range", schedule: true, guests: true, vocabulary: "guests", visibility: "shown" },
      rolesNeeded: ["venue", "event_coordinator", "caterer", "accommodation", "photography", "rentals"] },
    ...
    { slug: "engagement-party", name: "Engagement Party", tabs: engagementTabs, universalFilters: standardUniversalFilters,
      switches: { stops: "one", duration: "day", schedule: true, guests: true, vocabulary: "guests", visibility: "shown" },
      rolesNeeded: ["venue", "event_coordinator", "florist", "photography", "caterer", "entertainment"] },
    ...
    { slug: "corporate", name: "Corporate Retreats", tabs: corporateRetreatTabs, universalFilters: standardUniversalFilters,
      switches: { stops: "many", duration: "range", schedule: true, guests: true, vocabulary: "attendees", visibility: "shown" },
      rolesNeeded: ["venue", "event_coordinator", "av_tech", "caterer", "accommodation", "private_transportation", "activity_provider"] },
    { slug: "milestone-birthday", name: "Milestone Birthday", tabs: birthdayTabs, universalFilters: standardUniversalFilters,
      switches: { stops: "one", duration: "day", schedule: true, guests: true, vocabulary: "guests", visibility: "shown" },
      rolesNeeded: ["venue", "event_coordinator", "caterer", "entertainment", "photography", "videographer", "rentals", "florist"] },
