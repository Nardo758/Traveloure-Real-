...
export async function populateBookingOptionsForLeg(
  ...
  // Record AI-generated affiliate link events for all affiliate-type options.
  // These are generated by the AI transport planner (system agent), not by user action.
  for (const opt of options) {
    if (opt.bookingType === "affiliate" && opt.source) {
      affiliateService.trackLinkGenerated(opt.source, destination, {
