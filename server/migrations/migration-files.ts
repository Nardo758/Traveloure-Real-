...
export const MIGRATION_FILES = [
  ...
  // 2026-09-24-web-push (Locked Decision 53): `push_subscriptions` (new table, UNIQUE endpoint,
  // user index) + `notifications.push_claimed_at` (additive NULLABLE, NO DEFAULT, NO BACKFILL) and
