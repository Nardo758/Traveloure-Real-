...
**As of:** `6cf8ce851` (2026-09-24) — reconciled against `main` per ledger `2026-09-24-plan-v14-trip-pass-benefits`; see Appendix D for the change log.
