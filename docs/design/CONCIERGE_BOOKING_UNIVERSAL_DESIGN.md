...
| S5 | **Plan write** | The **linked** itinerary item is updated in place (`status='booked'`, reference). Never a second item (audit P1-4 / BP-5). Never `routing_status='purchased'` (LD 44). | fix required |
