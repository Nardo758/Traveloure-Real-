...
export default function ItineraryViewPage() {
  ...
  const planCardDays: PlanCardDay[] = data.variant.days.map(d => {
    ...
    activities: d.activities.map(a => ({
      ...
      cost: a.cost || 0,
      comments: 0,
      expertNote: ["notes_complete", "acknowledged"].includes(expertStatus || "")
    ...
    transports: d.transportLegs.map((l, li) => {
      ...
      return {
        ...
        bookingSource: "platform" as "platform" | "affiliate",
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto p-4 pb-12">
        ...
        {isOwnerView && data.expertNotes && (expertStatus === "acknowledged" || expertStatus === "notes_complete") && (
