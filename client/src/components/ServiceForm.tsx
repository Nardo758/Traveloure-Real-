...
export function ServiceForm({ role, id, onSuccess }: ServiceFormProps) {
  ...
  return (
    <div className={`w-full p-6 space-y-6 ${role === "provider" ? "max-w-6xl mx-auto" : "max-w-5xl"}`}>
      ...
      {onSection("map") && needsMeetingPoint && (
        <ServiceMapAuthoring
          ...
          pickupAvailable={formData.pickupAvailable}
          pickupProvisionChosen={pickupProvisionChosen}
          pickupCoverageMode={formData.pickupCoverageMode}
          onPickupCoverageModeChange={(mode) => set("pickupCoverageMode", mode)}
