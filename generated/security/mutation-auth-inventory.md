...
Generated from `server/routes.ts`. **587** raw mounted mutation registrations and **578** unique METHOD+normalizedPath pairs were found.

The unique-pair count is **+32** from the historical 546 comparison clue. The generator does not read that clue: it follows the current source mount graph. Raw registrations retain currently mounted, later-shadowed registrations; duplicate registrations are listed in the JSON manifest. A changed count indicates current route additions/removals or mount-graph changes, not an automatic regression.

Category totals: payments 31; admin 147; user-data 194; other 206.
Boundary totals: admin-role 147; session-self 297; resource-owner 90; signature 6; public-or-system 38; unknown 0.
...
| POST | `/api/chats` | other | session-self | no | unknown | `server/routes.ts:2191`<br>`server/routes/trips.routes.ts:666` | unknown | unknown |
...
| POST | `/api/itinerary-comparisons/:id/apply-to-cart` | other | session-self | no | unknown | `server/routes.ts:9728`<br>`server/routes/trips.routes.ts:822` | unknown | unknown |
...
| POST | `/api/itinerary-comparisons/:id/select` | other | session-self | no | unknown | `server/routes.ts:9698`<br>`server/routes/trips.routes.ts:793` | unknown | unknown |
| POST | `/api/itinerary-items/:id/backup` | other | session-self | no | unknown | `server/routes.ts:12218`<br>`server/routes/trips.routes.ts:1496` | unknown | unknown |
...
| POST | `/api/itinerary/estimate-travel` | other | session-self | no | unknown | `server/routes.ts:12312`<br>`server/routes/trips.routes.ts:1531` | unknown | unknown |
...
| POST | `/api/quick-start-itinerary` | other | session-self | no | unknown | `server/routes.ts:10967`<br>`server/routes/trips.routes.ts:862` | unknown | unknown |
...
| POST | `/api/trips` | user-data | public-or-system | no | unknown | `server/routes.ts:1355`<br>`server/routes/trips.routes.ts:505` | unknown | unknown |
| DELETE | `/api/trips/:id` | user-data | session-self | yes | unknown | `server/routes.ts:1500`<br>`server/routes/trips.routes.ts:591` | unknown | unknown |
| PATCH | `/api/trips/:id` | user-data | session-self | yes | unknown | `server/routes.ts:1472`<br>`server/routes/trips.routes.ts:549` | unknown | unknown |
