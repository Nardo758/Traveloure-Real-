...
| POST | `/api/chats` | other | session-self | no | unknown | `server/routes.ts:2189`<br>`server/routes/trips.routes.ts:666` | unknown | unknown |
...
| POST | `/api/itinerary-comparisons/:id/apply-to-cart` | other | session-self | no | unknown | `server/routes.ts:9661`<br>`server/routes/trips.routes.ts:822` | unknown | unknown |
...
| POST | `/api/itinerary-comparisons/:id/select` | other | session-self | no | unknown | `server/routes.ts:9631`<br>`server/routes/trips.routes.ts:793` | unknown | unknown |
| POST | `/api/itinerary-items/:id/backup` | other | session-self | no | unknown | `server/routes.ts:12151`<br>`server/routes/trips.routes.ts:1496` | unknown | unknown |
...
| POST | `/api/itinerary/estimate-travel` | other | session-self | no | unknown | `server/routes.ts:12245`<br>`server/routes/trips.routes.ts:1531` | unknown | unknown |
...
| POST | `/api/quick-start-itinerary` | other | session-self | no | unknown | `server/routes.ts:10900`<br>`server/routes/trips.routes.ts:862` | unknown | unknown |
...
| POST | `/api/trips` | user-data | public-or-system | no | unknown | `server/routes.ts:1353`<br>`server/routes/trips.routes.ts:505` | unknown | unknown |
| DELETE | `/api/trips/:id` | user-data | session-self | yes | unknown | `server/routes.ts:1498`<br>`server/routes/trips.routes.ts:591` | unknown | unknown |
| PATCH | `/api/trips/:id` | user-data | session-self | yes | unknown | `server/routes.ts:1470`<br>`server/routes/trips.routes.ts:549` | unknown | unknown |
