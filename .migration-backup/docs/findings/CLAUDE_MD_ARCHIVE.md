# CLAUDE.md Archive — findings & superseded ruling restatements

**Created 2026-08-04 (Execution Protocol lane, DECISIONS.md ruling 29).** Chronological in original CLAUDE.md order; every block carries its original line range and as-of SHA (`5941a4ff` = main at archiving; internal dates/SHAs inside entries are more specific where present). Rulings restated in MOVED-TO-LEDGER blocks are canonical in `docs/DECISIONS.md` — the text here is historical context, not authority. Where a live audit doc owns a topic, prefer it; nothing here is re-homed twice. All content below is VOLATILE-class: true only as-of its SHA.

---

<!-- FINDINGS class. Original CLAUDE.md lines 15-37, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 49-63, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 64-76, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 77-111, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 123-152, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 153-190, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 191-212, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 213-224, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 301-347, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 348-354, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 357-369, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 370-382, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 383-425, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 426-458, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 459-503, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 504-520, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 521-560, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 601-633, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 634-659, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 660-680, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 681-695, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 696-696, as-of 5941a4ff. -->
- **Approval divergences** (§1) — tracked (D1a/Phase 2). *(The coordination-fee $0-budget bug was fixed by #144 — see §7.)*

<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 697-709, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 710-717, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 726-758, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 781-798, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 818-866, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 867-951, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 952-993, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 994-1008, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 1009-1031, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 1032-1040, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1041-1071, as-of 5941a4ff. -->
...
<!-- MOVED-TO-LEDGER class (rulings restated here are canonical in docs/DECISIONS.md — cite by number). Original CLAUDE.md lines 1072-1105, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1159-1182, as-of 5941a4ff. -->
---
...
<!-- FINDINGS class. Original CLAUDE.md lines 1268-1304, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1305-1321, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1322-1353, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1354-1397, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1398-1461, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1462-1486, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1487-1503, as-of 5941a4ff. -->
...
<!-- FINDINGS class. Original CLAUDE.md lines 1530-1552, as-of 5941a4ff. -->
