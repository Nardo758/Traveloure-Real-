...
const keyFeatures = [
  ...
  { icon: Zap, label: "Live Intel", description: "Real-time local insights and spontaneous opportunities", href: "/destinations", gradient: "from-violet-500 to-purple-500" },
  { icon: Globe, label: "Discover", description: "Browse curated experiences from around the world", href: "/destinations", gradient: "from-ocean-500 to-ocean-600" },
];
