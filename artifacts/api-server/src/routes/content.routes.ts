...
import { transportLegs, sharedItineraries, mapsExportCache, expertUpdatedItineraries, affiliateProducts, affiliatePartners, contentRegistry } from "@workspace/db";
...
import { affiliateClicks } from "@workspace/db";
