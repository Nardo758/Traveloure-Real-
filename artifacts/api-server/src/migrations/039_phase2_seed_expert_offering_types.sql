-- Master Integration Brief — Phase 2: seed expert_offering_types per SEED_DATA §5.
--
-- ~39 expert offering rows across 5 service tiers:
--   advisory | planning | coordination | live_support | specialized.
-- delivery_formats: chat | written | video | live_text | done_for_you.
-- is_surprising = true marks the "I never knew" row per brief §7.
--
-- ai_plan_polish is the $49.99 AI+Expert-Review tier (matches fee_bands.optimize_expert_review).
