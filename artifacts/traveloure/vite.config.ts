...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'drizzle-orm/pg-core': path.resolve(
        import.meta.dirname,
        'node_modules',
        'drizzle-orm',
        'pg-core',
  ...
  server: {
    ...
    host: '0.0.0.0',
    allowedHosts: true,
    // The recovered Field Guide frontend owns the public preview. Keep its API calls
    // same-origin by forwarding them to the existing Traveloure backend process.
    proxy: {
      '/api': {
