...
// no early-return the sandbox's dummy `STRIPE_SECRET_KEY=[REDACTED_STRIPE_TEST_KEY]` can reach (unlike the
...
async function main() {
  ...
  try {
    ...
    // STRIPE_SECRET_KEY=[REDACTED_STRIPE_TEST_KEY] can reach; the agent proxy mangles the response
