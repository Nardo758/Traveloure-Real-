...
const specifications = [
  ...
  { id: "payments-other-rails-ownership", context: "payments-other-rails-owner", file: "server/__tests__/mutation-auth/payments-other-rails-mutation-auth.test.ts", live: true },
